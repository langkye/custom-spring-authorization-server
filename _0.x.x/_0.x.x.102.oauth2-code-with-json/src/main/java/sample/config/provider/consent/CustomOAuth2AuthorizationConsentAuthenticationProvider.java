 ...
 * @author Joe Grandja
 * @since 0.4.0
 * @see CustomOAuth2AuthorizationConsentAuthenticationToken
 ...
 */
@Component
public final class CustomOAuth2AuthorizationConsentAuthenticationProvider implements AuthenticationProvider {
	...
	private OAuth2TokenGenerator<OAuth2AuthorizationCode> authorizationCodeGenerator = new CustomOAuth2AuthorizationCodeGenerator();
	 ...
	 */
	public CustomOAuth2AuthorizationConsentAuthenticationProvider(RegisteredClientRepository registeredClientRepository
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		CustomOAuth2AuthorizationConsentAuthenticationToken authorizationConsentAuthentication = (CustomOAuth2AuthorizationConsentAuthenticationToken) authentication;
		...
		if (authorization == null) {
			throwError(OAuth2ErrorCodes.INVALID_REQUEST, OAuth2ParameterNames.STATE, authorizationConsentAuthentication, null, null);
		}
	...
	public boolean supports(Class<?> authentication) {
		return CustomOAuth2AuthorizationConsentAuthenticationToken.class.isAssignableFrom(authentication);
	}
	 ...
	 * {@link CustomOAuth2AuthorizationConsentAuthenticationToken}.</li>
	...
	private static OAuth2TokenContext createAuthorizationCodeTokenContext(
			CustomOAuth2AuthorizationConsentAuthenticationToken authorizationConsentAuthentication,
