...
public class CustomOAuth2AuthorizationCodeRequestAuthenticationProvider implements AuthenticationProvider {
     ...
     */
    public CustomOAuth2AuthorizationCodeRequestAuthenticationProvider(
    ...
    public boolean supports(Class<?> authentication) {
        return CustomOAuth2AuthorizationCodeRequestAuthenticationToken.class.isAssignableFrom(authentication);
    }
