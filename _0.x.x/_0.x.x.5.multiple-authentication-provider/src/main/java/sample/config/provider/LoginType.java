...
public enum LoginType {
    ...
    private final Function<ILoginRequest, ITokenProvider> function;

    LoginType(Number type, String typeName, Function<ILoginRequest, ITokenProvider> function) {
        this.type = type;
    ...
    public Function<ILoginRequest, ITokenProvider> getFunction() {
        return function;
    }
    
    public static LoginType of(Number type) {
